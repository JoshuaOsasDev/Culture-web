      ...
      <div className={styles.historyDisplay}>
        ...
        <div>
          ...
          <p>
            ...
            iste blanditiis molestias maiores, et minus laudantium culpa
            inventore soluta, laborum assumenda error magni labore vitae itaque
            odit quas praesentium?
          </p>
          ...
          <p>
            ...
            cum nobis neque distinctio voluptate consequuntur, excepturi ullam a
            ex repellat. Magnam, optio atque laudantium, possimus minima
